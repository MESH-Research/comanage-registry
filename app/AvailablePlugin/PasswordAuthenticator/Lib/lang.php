...
$cm_password_authenticator_texts['en_US'] = array(
  ...
  'pl.passwordauthenticator.username'       => 'Username',
  'pl.passwordauthenticator.show_username'  => 'Show Username',
  'pl.passwordauthenticator.show_username.desc' => 'If enabled, the username will be displayed on the Self Service Password Edit page',
  'pl.passwordauthenticator.username_identifier_type' => 'Username Identifier Type',
  'pl.passwordauthenticator.username_identifier_type.desc' => 'The identifier type to use when looking up the username for the Self Service Password Edit page',
  'pl.passwordauthenticator.username_from_org_identity' => 'Use Username from Org Identity source',
  'pl.passwordauthenticator.username_from_org_identity.desc' => 'If enabled, the username will be looked up from the Org Identity source rather than the CO Person record',
  'pl.passwordauthenticator.username_help_text' => 'Username Help Text',
  'pl.passwordauthenticator.username_help_text.desc' => 'Help text for username field on Self Service Password Edit page',
  'pl.passwordauthenticator.username_help_text.default' => 'Your login username',
  'pl.passwordauthenticator.authenticator_help_text' => 'Authenticator Help Text',
  'pl.passwordauthenticator.authenticator_help_text.desc' => 'Help text appearing above the password entry form on the Self Service Password Edit page',
  'pl.passwordauthenticator.authenticator_help_text.default' => '',
  'pl.passwordauthenticator.remove_domain_from_username' => 'Remove Domain when displaying username',
  'pl.passwordauthenticator.remove_domain_from_username.desc' => 'If enabled, the domain will be removed from the username when displaying it on the Self Service Password Edit page',
);
