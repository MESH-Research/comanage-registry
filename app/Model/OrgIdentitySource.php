...
class OrgIdentitySource extends AppModel {
  ...
  public function syncAll($coJobId, $coId, $force=falsei, $oisId='', $skipNew=false) {
    $errors = array();
  ...
  public function syncOrgIdentitySource($orgIdentitySource, $force=false, $coJobId=null, $skipNew) {
